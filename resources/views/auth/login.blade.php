            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <div class="from-check">
                        <input class="from-check-input" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>

                        <label class="from-check-ladel samuraimart-check-ladel w-100" for="remember">
                            次回から自動的にログインする
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-link mt-3 d-flex justify-content-cemtter samuraimart-login-text" href="{{ route('password.request') }}">
                        パスワードをお忘れの場合
                    </a>
                </div>
            </form>
